...
if (@!$_SESSION['nom_administrador']) {
  ...
  header("Location:login/menu_user.php");
	...
	ActualizarRegistro($_POST["expediente"],$_POST["nombre"],$_POST["apellidos"],$_POST["cbx_linea"],$_POST["cbx_estacion"],$_POST["cbx_id_estacion"],$_POST["areas"],$_POST["categoria"],$_POST["correo"],$_POST["nom_usuario"],$_POST["pass"]
		,$_POST["rol"],$_POST["id_usuario"]);
