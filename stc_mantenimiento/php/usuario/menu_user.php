...
<!--................................MENÚ DESPLEGABLE............................................-->
  <div class="contenedor">
    ...
    <nav class="menu">
       ...
       <li id="Inicio"><a id="text_inicio" href="home_user.html"> <img src="../../imagenes/home-icon.png" id="home-icon"> Inicio</a></li>
       <li id="config"><a href=""> <img src="../../imagenes/config-icon.png" id="config-icon">Configuración</a></li>
       <li id="info"><a href="sobre_sitio_web_user.html"> <img src="../../imagenes/about-icon.png" id="about-icon">Sobre el sitio web</a></li>
       <li id="cerrar"><a href="../login/desconectar_usuario.php"> <img src="../../imagenes/logout-icon.png" id="logout-icon">Cerrar sesión</a>
    </nav>
  </div>
