...
<html lang="es">
	<head>
        <title>Manuales: Pilojate Automático</title>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<h2 style="text-align:center">MANUALES DE PILOTAJE AUTOMÁTICO L-12</h2>
			</div>
        ...
        $db=new Conect_MySql();
            $sql = "SELECT * FROM manuales WHERE area = 'PA L-12' ORDER BY titulo ASC";
            ...
            <tr>
                ...
                <td>
                    <?php 
                        $path = "../../../actualizacion_manuales/pilotaje-automatico/manuales/". $datos['id_manual'];
                        if(file_exists($path)){
